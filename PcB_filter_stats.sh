...
stat=( $all )
echo -e "tar_file\tdir\tsmrtcell\tpre-bases\tpre-reads\tpre-n50\tpre-mean_len\tpre-mean_read_score\tpost-bases\tpost-reads\tpost-n50\tpost-mean_len\tpost-mean_read_score"
